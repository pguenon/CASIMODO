...
##################### STEP TO PERFORM ########################
step_to_perform=all # Options: all (default), discretize_conformations, get_distances_between_coordinates, get_frequencies, get_mutual_information, get_entropy, clusterize_MI
##############################################################

###################### PARAMETERS TO MODIFY ##########################
struc_file=Data_files/REMD_THROMBIN_WT_NA_full_center_fit0.gro
trj_file=Data_files/REMD_THROMBIN_WT_NA_full_center_fit.xtc
dic_file=dic_terminal_atoms_thrombin.txt
ouput_directory=results_PROCONF_THROMBIN_WT_NA # Directory where the results will be saved
time_zero=200000 # Time in ps to start the analysis
...
########################### OPTIONAL PARAMETERS #################################
#optional parameters
coordinates_to_add=() # Path to time evolution of coordinates to add to the analysis
# Example: coordinates_to_add=(Data_files/coordinate1.dat Data_files/coordinate2.dat)
type_coordinates_to_add=() # Type of coordinates to add to the analysis
# Example: type_coordinates_to_add=(type1 type2)
barycenter_coordinates_to_add=() # Atom to consider as the barycenter of the coordinates to add
